...
[orbit-space reduction calculus](nodes/orbit-space-reduction-calculus.md).
...
[decomposition decision engine](nodes/decomposition-decision-engine.md).  It generates
...
[observable-cyclic-calculus.md](nodes/observable-cyclic-calculus.md).  Exact termination
...
Apply the [filtered centralizer calculus](nodes/filtered-centralizer-calculus.md).
...
[quadratic centralizer generator](nodes/quadratic-centralizer-generator.md) is the first
...
The [radial extension](nodes/radial-centralizer-extension.md) retains the same modules
...
The [complete `E^3` backend](nodes/e3-quadratic-centralizer.md) adds the first nontrivial
...
- **Spinor PDE regression:** from connection curvature and Clifford multiplication,
  ...
  [group-free full-operator lift](nodes/full-operator-covariance-lift.md) independently
  ...
  [nonzero transport continuation](nodes/nonzero-first-order-transport.md) passes aligned
  ...
  [matrix transport continuation](nodes/matrix-valued-transport-algebra.md) constructs
  ...
  [finite split continuation](nodes/finite-semisimple-coefficient-algebra.md) removes the
