...
```powershell
uv run physics\mathematical-physics\PDE-group-research\computation\axial_quotient_pde.py `
  physics\mathematical-physics\PDE-group-research\computation\examples\axial-nonseparable-manufactured.json `
  --summary
