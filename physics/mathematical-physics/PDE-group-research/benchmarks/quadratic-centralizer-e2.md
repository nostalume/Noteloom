...
The [quadratic generator](../nodes/quadratic-centralizer-generator.md) replaces the
...
```powershell
python physics\mathematical-physics\PDE-group-research\computation\quadratic_centralizer.py `
  physics\mathematical-physics\PDE-group-research\computation\examples\rotated-quartic.json `
  --summary
```
