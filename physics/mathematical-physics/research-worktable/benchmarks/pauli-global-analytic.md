...
```powershell
python physics/mathematical-physics/research-worktable/computation/reduction_workbench.py `
  discover `
  physics/mathematical-physics/research-worktable/computation/examples/pauli-landau-global-positive.json `
  --summary
```
