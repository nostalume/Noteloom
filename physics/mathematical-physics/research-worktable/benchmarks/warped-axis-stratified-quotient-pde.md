...
```powershell
uv run physics\mathematical-physics\research-worktable\computation\warped_axis_quotient_pde.py `
  physics\mathematical-physics\research-worktable\computation\examples\warped-axis-manufactured.json `
  --summary
