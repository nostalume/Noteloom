...
```powershell
python physics\mathematical-physics\research-worktable\computation\singular_polynomial_closure.py `
  physics\mathematical-physics\research-worktable\computation\examples\singular-isotropic-e2.json `
  --summary
```
