...
### G17 — Prepared-observable active-subspace propagation
...
- **Next probe:** adapt the existing matrix-free cyclic constructor to one
  Gaussian-Hermitian G15 block, certify invariance and observable recovery, then
  compare active dimension and complete cost across the G16 family.
