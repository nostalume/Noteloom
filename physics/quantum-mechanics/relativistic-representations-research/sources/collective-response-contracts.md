...
- **Internal use:** node 08 re-derives the response from continuity and the leading
...
- **Internal use:** node 08 uses this only to type the downstream stochastic/large-
