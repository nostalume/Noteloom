...
- **Research use:** node 08 constructs the effective-mass tensor from the curvature
...
- **Research use:** node 08 reconstructs the formula invariantly for the NC-02
...
- **Boundary:** the paper studies a single dressed electron, not the neutral
  composite of node 08; its ultraviolet asymptotics are not transferred to that
  atom.
...
- **Research use:** node 08 expands the gapped scalar atom--radiation self-energy to
