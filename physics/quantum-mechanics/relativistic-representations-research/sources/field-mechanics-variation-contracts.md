...
- **Research use:** node 08 derives the elementary projected-resolvent and recovery
...
- **Research use:** this validates the *shape* of node 08's field/mechanics bridge:
...
- **Boundary:** this review does not supply a nonperturbative error bound for the
  one-electron Dirac--Coulomb limit used in node 08. Kernel truncation, gauge
...
- **Research use:** node 08 treats charge distribution, heavy-source preparation,
...
- **Boundary:** the paper computes within a spherical short-distance expansion
  and uses radial solutions for applications. node 08 consumes only the source-to-
...
- **Research use:** this is the domain/stability theorem contract for the
  finite-source mechanical representatives in node 08.
- **Boundary:** norm-resolvent continuity for every singular source variation is
  not inferred. node 08's explicit contour estimate is supported first for bounded
