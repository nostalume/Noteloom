...
- **Research use:** node 08 obtains a physically meaningful dressed neutral-atom
...
- **Output consumed:** fixed-total-momentum Hamiltonians `H_g(P)`; a simple
  ...
  threshold.
- **Research use:** node 08 identifies the same dressed-atom vector as a fiber
...
- **Sources:** NC-01 and NC-02, together with
  [node 08's operator contract](field-mechanics-variation-contracts.md).
...
- **Research use:** node 08 uses the spectral atom
